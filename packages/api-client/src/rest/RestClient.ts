...
export class RestClient {
  ...
  constructor(options: RestClientOptions) {
    ...
    this.baseURL = options.baseURL ?? (typeof process !== 'undefined' ? process.env.BEACON_API_URL : null) ?? (typeof window !== 'undefined' && (window as any).BEACON_API_URL) ?? 'https://api.beacon.qzz.io';
