...
import styles from '../../styles/modules/features/RoleManager.module.css'
            ...
            .map((role, index) => (
              <div
                ...
                onDragStart={(e) => {
                  ...
                  // Set a drag image or allow default
                }}
                onDragOver={(e) => {
                ...
                onDrop={(e) => {
                  ...
                  useRolesStore.getState().reorderRoles(serverId, newRoles)
                  setDraggedRoleIndex(null)
                }}
                className={`${styles.roleItem} ${selectedRole?.id === role.id ? styles.active : ''
                  }`}
