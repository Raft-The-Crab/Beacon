...
import { BeacoinRewards } from './BeacoinRewards'
import styles from '../../styles/modules/features/BeacoinWallet.module.css'
...
export function BeacoinWallet({ onClose }: BeacoinWalletProps) {
  ...
  const [tab, setTab] = useState<'wallet' | 'send' | 'earn'>('wallet')
      ...
      <div className={styles.wallet} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.balanceCard}>
          ...
          <div className={styles.balanceActions}>
            ...
            <button className={styles.actionBtnSecondary} onClick={() => setTab('earn')}>
              <Gift size={15} />
              Earn More
            </button>
          </div>
        ...
        <div className={styles.tabs}>
          ...
          <button
            className={`${styles.tab} ${tab === 'earn' ? styles.tabActive : ''}`}
            onClick={() => setTab('earn')}
          >
            Earn
          </button>
